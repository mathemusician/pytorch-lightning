...
Whereas :class:`~pytorch_lightning.plugins.training_type.DDPPlugin` only performs 2 transfer operations: moving data to device and transfer and sync gradients, making DDP MUCH faster than DP.
